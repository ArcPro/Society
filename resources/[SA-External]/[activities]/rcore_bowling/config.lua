Config = {
	...
	Text = {
		...
		REGISTER_LANE = '~INPUT_PICKUP~ %sCréer une nouvelle partie~n~~INPUT_SPRINT~ + ~INPUT_PICKUP~ %sCréer une nouvelle partie en équipe',
		JOIN_LANE = '~INPUT_PICKUP~ %sRejoindre la partie',
		PLAY = '~INPUT_PICKUP~ Jouer',
		OPEN = '~INPUT_PICKUP~ Ouvrir',
		TAKE_BALL = '~INPUT_PICKUP~ Prendre la balle',

		NOT_IN_GAME = 'Vous ne participer à aucune partie.',
		NOT_ENOUGH_MONEY = "Vous n'avez pas assez d'argent",
		NOT_ENOUGH_MONEY_FEE = "Vous n'avez pas assez d'argent",
		NOT_ENOUGH_MONEY_AND_FEE = "Vous n'avez pas assez d'argent",
		INPUT_POSITION = 'Choisissez la position initiale de la ~y~boule\'s~s~',
		INPUT_ROTATION = 'Choisissez la ~y~rotation~s~ de la boule',
		INPUT_ANGLE = 'Choisissez l\'~y~angle de jetée~s~',
		INPUT_POWER = 'Choisissez la ~y~puissance de jetée~s~',

        TOTAL = "Total",
        MATCH_END = "La partie finit dans {0} secondes",
		MATCH_WHO_WON = "{0} a gagné ${1}",
		...
		REGISTER = "S'inscrire",
		WAGER = "Pari",
		WAGER_SET_TO = "Pari défini à <b>${0}</b>",
		...
		YOUR_NAME = 'Votre nom',
		LEFT_LANE = 'Vous avez quitté la partie.'
	},
	ThrowWait = 1800,
}
