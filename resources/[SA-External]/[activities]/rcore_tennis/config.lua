...
Config = {
    ...
    BallElasticity = 1.2,
    Tutorial = {
        {text = 'La partie commencera quand deux joueurs auront rejoint, un de chaque coté', time = 5000},
        {text = 'Pour servir, ~y~allez sur le marker~s~, appuyez sur ~y~E~s~ pour servir.', time = 5000},
        {text = 'Quand vous servez, ~y~déplacez vous à l\'endroit~s~ où vous voulez servir et ~y~appuyez sur clic gauche~s~', time = 5000},
        {text = '~y~Choisissez la puissance~s~ avec laquelle vous voulez servir, et utilisez ~y~ZQSD~s~ pour viser.', time = 5000},
        {text = 'Quand vous servez, ~y~visez toujours le coin en diagonale~s~, pour cela, utilisez ~y~A~s~ ou ~y~AW~s~.', time = 5000},
        {text = "Avant de ~y~retourner~s~, il est plus facile d'attendre que la balle ~y~rebondisse~s~ du sol.", time = 5000},
        {text = "~y~La rotation du bas portera la balle ~y~plus loin~s~, ~y~la rotation du haut portera la balle ~y~moins loin~s~.", time = 5000},
    },
    Translation = {
        ...
        YOU_WON_GAME = '~g~Vous gagnez la partie!',
        ...
        SERVE_HINT = 'Pour servir correctement, visez avec la touche ~y~~a~s~ pour frapper le rectangle ~g~highlighted~s~.~n~La balle doit ~y~atteindre le sol~s~ en premier avant que l\'adversaire ne puisse la renvoyer.~n~y~CLICK~s~ GAUCHE pour initier le service.',
...
TennisCourts = {
    ...
    azgard1 = {
        ...
        collisionSuspendedUntil = 0,
        isCollisionActive = false,
        courtCenter = vec3(-1678.756714, -767.770874, 9.52),
        courtHeading = 230.482773,
        courtWidth = 8.0,
        courtLength = 11.89,
        centerConstant = 0.0,
        showBlip = true,
    ...
    azgard2 = {
        ...
        collisionSuspendedUntil = 0,
        isCollisionActive = false,
        courtCenter = vec3(-1651.285156, -790.37799, 9.52),
        courtHeading = 230.482773,
        courtWidth = 8.0,
        courtLength = 11.89,
        centerConstant = 0.0,
