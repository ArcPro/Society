Config = {
    ...
    Text = {
        ...
        BALL_IN_HAND_BACK = "Poser la balle",
        AIM_LEFT = "Viser à gauche",
        AIM_RIGHT = "Viser à droite",
        AIM_SLOWER = "Viser moins vite",

        POOL = 'Billard',
        POOL_GAME = 'Jeu du billard',
        POOL_SUBMENU = '',
        TYPE_9_BALL = '9-ball',
        ...
        HINT_TAKE_CUE = 'Prendre la queue',
        HINT_RETURN_CUE = 'Poser la queue',
        HINT_HINT_TAKE_CUE = 'Pour jouer, prenez une queue',
        HINT_PLAY = 'Jouer',
        ...
        BALL_POCKETED = 'La boule %s a été rentrée',
        BALL_IN_HAND_NOTIFY = 'Player a pris la boule blanche en main',
        BALL_LABELS = {
            [-1] = 'blanche',
            [1] = '~y~Pleine 1~s~',
            [2] = '~b~Pleine 2~s~',
