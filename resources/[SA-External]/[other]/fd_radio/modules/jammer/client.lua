...
function populateJammer(coords, heading, uuid)
    local object = exports["SidGamemode"]:createJammer(coords, uuid)
...
function newJammer(uuid, data)
    ...
    jammers[uuid].zone:onPlayerInOut(function(isPointInside, point)
        if isPointInside then
            ...
            jammers[uuid].object = populateJammer(jammers[uuid].coords, jammers[uuid].heading, uuid)
...
exports("deleteJammer", function(id)
	callback.await("fd_radio:removeJammerCB", false, id)
end)
