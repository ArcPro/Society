...
exports('getCallAndRadioData', function(onlyCall)
	return {
		radioData = onlyCall == true and {} or radioData,
		callData = callData,
	}
end)
...
if gameVersion == 'fivem' then
	...
	SetAudioSubmixEffectParamFloat(radioEffectId, 0, `freq_low`, 100.0)
	SetAudioSubmixEffectParamFloat(radioEffectId, 0, `freq_hi`, 5000.0)
	SetAudioSubmixEffectParamFloat(radioEffectId, 0, `rm_mod_freq`, 300.0)
	SetAudioSubmixEffectParamFloat(radioEffectId, 0, `rm_mix`, 0.1)
	SetAudioSubmixEffectParamFloat(radioEffectId, 0, `fudge`, 4.0)
	SetAudioSubmixEffectParamFloat(radioEffectId, 0, `o_freq_lo`, 300.0)
	SetAudioSubmixEffectParamFloat(radioEffectId, 0, `o_freq_hi`, 5000.0)
