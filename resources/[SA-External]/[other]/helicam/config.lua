...
Config.InstructionButtons = {
    ...
    [0] = { control = "~INPUT_662F7BF5~", label = "Ajouter/Retirer le marker" },
    [1] = { control = "~INPUT_DB471A88~", label = "Changer la vision" },
    [2] = { control = "~INPUT_51D50495~", label = "Lumière" },
    [3] = { control = "~INPUT_5D25DCCD~", label = "Quitter la caméra" }
}
...
Config.Localisation = {
    -- Notifications
    Notification = {
        JobNotWhitelisted = "Vous n'avez pas le travail requis !",
        JobGrade = "Votre grade de travail est trop bas !",
        NoCameraHeli = "Cet hélicoptère n'a pas de caméra !",
        NoCameraPlane = "Cet avion n'a pas de caméra !",
        IsPilot = "Vous ne pouvez pas utiliser la caméra en tant que pilote !",
        NotInRear = "Vous devez être à l'arrière de l'hélicoptère pour utiliser la caméra !",
        CameraInUse = "Quelqu'un d'autre utilise déjà la caméra !",
        SpotlightInUse = "Quelqu'un d'autre utilise déjà le projecteur de la caméra !",
        NoSpotlight = "Cet hélicoptère n'a pas de projecteur !",
        SpotlightGlobalLimit = "La limite globale de projecteurs a été atteinte !",
        CannotRappelFromHeli = "Cet hélicoptère ne supporte pas le rappel !",
        CannotRappelFromSeat = "Vous ne pouvez pas faire de rappel depuis ce siège !",
        ToHighToRappel = "L'hélicoptère est trop haut pour faire du rappel !",
        ConfirmRappel = "Êtes-vous sûr de vouloir faire du rappel ? (Appuyez à nouveau pour confirmer)",
        Rappeling = "En rappel !"
    },
    -- Blip Names
    Blip = {
        Target = "Cible Helicam",
        Marker = "Marqueur Helicam"
    },
    -- Keybinding Descriptions
    KeyMapping = {
        ToggleCam = "Helicam - Activer/Désactiver la Caméra",
        AttemptLock = "Helicam - Tentative de Verrouillage",
        CycleVision = "Helicam - Changer de Vision",
        ToggleMarker = "Helicam - Ajouter/Supprimer des Marqueurs",
        Rappel = "Helicam - Rappel depuis l'Hélicoptère",
        Spotlight = "Helicam - Activer/Désactiver le Projecteur",
        SpotlightBrightness = "Helicam - (+ défilement) Régler la Luminosité du Projecteur",
        SpotlightRadius = "Helicam - (+ défilement) Régler le Rayon du Projecteur",
        Postals = "Helicam - Activer/Désactiver les Codes Postaux"
    },
    ChatSuggestions = {
        ToggleCamera = "Entrer/Sortir de la caméra de l'hélicoptère",
        Rappel = "Faire du rappel depuis l'hélicoptère"
    }
}
