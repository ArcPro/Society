...
function F_02668(arg1)
    ...
    Citizen.CreateThread(function()
        ...
        local scaleform = RequestScaleformMovieSkipRenderWhilePaused("HACKING_PC")
        ...
        while true do
            ...
            if Dat_2[1].val0 == 1 then
                DrawSprite("hackingNG", "DHComp", 0.35, Dat_1[1].val1, 0.4, 0.4, 0.0, 255, 255, 255, 255)
            elseif Dat_2[1].val0 == 0 then
                DrawSprite("hackingNG", "DHCompHi", 0.35, Dat_1[1].val1, 0.4, 0.4, 0.0, 255, 255, 255, 255)
            end
            if Dat_2[2].val0 == 1 then
                DrawSprite("hackingNG", "DHComp", 0.40, Dat_1[2].val1, 0.4, 0.4, 0.0, 255, 255, 255, 255)
            elseif Dat_2[2].val0 == 0 then
                DrawSprite("hackingNG", "DHCompHi", 0.40, Dat_1[2].val1, 0.4, 0.4, 0.0, 255, 255, 255, 255)
            end
            if Dat_2[3].val0 == 1 then
                DrawSprite("hackingNG", "DHComp", 0.45, Dat_1[3].val1, 0.4, 0.4, 0.0, 255, 255, 255, 255)
            elseif Dat_2[3].val0 == 0 then
                DrawSprite("hackingNG", "DHCompHi", 0.45, Dat_1[3].val1, 0.4, 0.4, 0.0, 255, 255, 255, 255)
            end
            if Dat_2[4].val0 == 1 then
                DrawSprite("hackingNG", "DHComp", 0.50, Dat_1[4].val1, 0.4, 0.4, 0.0, 255, 255, 255, 255)
            elseif Dat_2[4].val0 == 0 then
                DrawSprite("hackingNG", "DHCompHi", 0.50, Dat_1[4].val1, 0.4, 0.4, 0.0, 255, 255, 255, 255)
            end
            if Dat_2[5].val0 == 1 then
                DrawSprite("hackingNG", "DHComp", 0.55, Dat_1[5].val1, 0.4, 0.4, 0.0, 255, 255, 255, 255)
            elseif Dat_2[5].val0 == 0 then
                DrawSprite("hackingNG", "DHCompHi", 0.55, Dat_1[5].val1, 0.4, 0.4, 0.0, 255, 255, 255, 255)
            end
            if Dat_2[6].val0 == 1 then
                DrawSprite("hackingNG", "DHComp", 0.60, Dat_1[6].val1, 0.4, 0.4, 0.0, 255, 255, 255, 255)
            elseif Dat_2[6].val0 == 0 then
                DrawSprite("hackingNG", "DHCompHi", 0.60, Dat_1[6].val1, 0.4, 0.4, 0.0, 255, 255, 255, 255)
            end
            if Dat_2[7].val0 == 1 then
                DrawSprite("hackingNG", "DHComp", 0.65, Dat_1[7].val1, 0.4, 0.4, 0.0, 255, 255, 255, 255)
            elseif Dat_2[7].val0 == 0 then
                DrawSprite("hackingNG", "DHCompHi", 0.65, Dat_1[7].val1, 0.4, 0.4, 0.0, 255, 255, 255, 255)
            end
