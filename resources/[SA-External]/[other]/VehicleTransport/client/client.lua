...
function AttachVehicle(vehicle, transportVehicle)
	...
	if (#(GetEntityVelocity(vehicle) - GetEntityVelocity(transportVehicle)) > Config.maxAttachSpeedDiff) then
		exports.SidUI:AddNotification("basic", Lang.vehicleTooFastNotif, "info", 5000)
	else
		...
		exports.SidUI:AddNotification("basic", Lang.vehicleAttachedNotif, "info", 5000)
...
function DetachVehicle(vehicle)
	...
	exports.SidUI:AddNotification("basic", Lang.vehicleDetachedNotif, "info", 5000)
...
function ToggleDoor(transportVehicle, transport)
	if (GetVehicleDoorLockStatus(transportVehicle) == 2) then
		exports.SidUI:AddNotification("basic", Lang.vehicleLockedNotif, "info", 5000)
